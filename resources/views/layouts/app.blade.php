...
<body class="bg-stone-100 font-sans" x-data="{ sidebarOpen: true }">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
            ...
            <a href="{{ route('broker.payments.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.payments.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
