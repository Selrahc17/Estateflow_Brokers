...
<body class="bg-stone-100 font-sans" x-data="{ sidebarOpen: true }" @resize.window="sidebarOpen = window.innerWidth >= 1024">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
            ...
            <a href="{{ route('broker.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.dashboard') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <span x-show="sidebarOpen" class="text-sm font-medium">Dashboard</span>
            </a>

            <a href="{{ route('broker.properties.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.properties.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.lots.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.lots.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.reservations.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.reservations.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <span x-show="sidebarOpen" class="text-sm font-medium">Reservations</span>
            </a>

            <a href="{{ route('broker.site-visits.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.site-visits.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.clients.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.clients.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span x-show="sidebarOpen" class="text-sm font-medium">Clients</span>
            </a>

            <a href="{{ route('broker.documents.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.documents.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.notifications.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.notifications.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.chat.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.chat.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
            ...
            <a href="{{ route('broker.reports.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('broker.reports.*') ? 'bg-amber-600 text-white' : 'text-stone-300 hover:bg-stone-800' }} transition">
        ...
        <div class="border-t border-stone-700 p-3">
            <a href="{{ route('broker.settings.index') }}" class="flex items-center gap-3 px-2 py-2 rounded-lg text-stone-300 hover:bg-stone-800 transition">
    ...
    <div :class="sidebarOpen ? 'ml-64' : 'ml-16'" class="transition-all duration-300 min-h-screen flex flex-col">
        ...
        <header class="bg-white border-b border-stone-200 px-6 py-4 flex items-center justify-between sticky top-0 z-40">
            ...
            <div class="flex items-center gap-3">
                ...
                @endphp
                @if($unreadCount > 0)
                    <a href="{{ route('broker.notifications.index') }}" class="relative text-stone-500 hover:text-amber-600 transition">
                ...
                @else
                    <a href="{{ route('broker.notifications.index') }}" class="text-stone-500 hover:text-amber-600 transition">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                    </a>
                @endif
