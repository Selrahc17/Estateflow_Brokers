...
<body class="bg-stone-100 font-sans">
    <aside class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-stone-900 text-white">
        ...
        <nav class="flex-1 px-3 py-5">
            <a href="{{ route('broker.dashboard') }}" class="flex items-center gap-3 rounded-lg bg-red-600 px-3 py-2.5 text-sm font-medium text-white">
            ...
            <a href="{{ route('broker.performance') }}" class="mt-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-300 transition hover:bg-stone-800">
            ...
            <a href="{{ route('broker.property-lists') }}" class="mt-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-300 transition hover:bg-stone-800">
            ...
            <div class="mt-6 space-y-1">
                ...
                <a href="{{ route('broker.agents.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-300 transition hover:bg-stone-800">
                ...
                <span class="flex cursor-not-allowed items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-500" title="Coming soon">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2"/></svg>
            ...
            <div class="mt-6 space-y-1">
                ...
                <a href="{{ route('broker.messages.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-300 transition hover:bg-stone-800">
            ...
            <div class="mt-6 space-y-1">
                ...
                <a href="{{ route('broker.settings.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-300 transition hover:bg-stone-800">
        ...
        <div class="border-t border-stone-700 p-4">
            ...
            <span class="mt-3 flex items-center gap-2 rounded-lg px-2 py-2 text-xs font-medium text-stone-300 transition hover:bg-stone-800">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31.826-2.37-2.37a1.724 1.724 0 001.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31-2.37-2.37a1.724 1.724 0 002.572 1.065z"/><path class="stroke-current" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Profile Settings
            </span>
            <form action="{{ route('auth.logout') }}" method="POST" class="mt-3">
                @csrf
                <button type="submit" class="w-full rounded-lg border border-stone-700 px-3 py-2 text-left text-xs text-stone-300 transition hover:bg-stone-800">Sign Out</button>
            </form>
        </div>
    </aside>
