...
<body class="bg-stone-100 font-sans min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl border border-stone-200 p-8 shadow-sm text-center">
            ...
            {{-- Resend --}}
            <button class="w-full bg-amber-600 hover:bg-amber-700 text-white py-3 rounded-xl font-semibold text-sm transition mb-3">
            ...
            <p class="text-xs text-stone-400 mt-5">
                Wrong email?
                <a href="{{ route('auth.register') }}" class="text-amber-600 hover:underline">Register again</a>
            </p>
