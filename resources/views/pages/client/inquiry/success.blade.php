...
<div class="max-w-lg mx-auto px-6 py-16 text-center">
    ...
    <div class="bg-stone-50 rounded-2xl p-5 text-left mb-6">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-start gap-3">
                <div class="w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0">{{ $step[0] }}</div>
                <div>
    ...
    <div class="flex flex-col sm:flex-row gap-3">
        ...
        <a href="{{ route('auth.register') }}" class="flex-1 bg-amber-600 hover:bg-amber-700 text-white py-3 rounded-xl text-sm font-semibold transition text-center">
            Create an Account
        </a>
    </div>
    ...
    <p class="mt-4 text-xs text-stone-400">
        Have questions?
        <a href="{{ route('client.contact') }}" class="text-amber-600 hover:underline">Contact us</a>
    </p>
