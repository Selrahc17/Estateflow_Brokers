        ...
        <div class="lg:col-span-3 space-y-8">
            ...
            <div id="overview" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">1</span>
                    Overview
                </h2>
            ...
            <div id="collection" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">2</span>
                    Data We Collect
                </h2>
                <div class="space-y-4 text-sm text-stone-500">
                    <div>
                        ...
                        <ul class="space-y-1.5 list-none">
                            ...
                            <li class="flex items-start gap-2"><span class="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5 shrink-0"></span>{{ $item }}</li>
                            @endforeach
                        </ul>
                    </div>
                    <div>
            ...
            <div id="usage" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">3</span>
            ...
            <div id="sharing" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">4</span>
                    Data Sharing
                </h2>
            ...
            <div id="security" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">5</span>
                    Data Security
                </h2>
            ...
            <div id="cookies" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">6</span>
                    Cookies
                </h2>
            ...
            <div id="rights" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">7</span>
                    Your Rights
                </h2>
            ...
            <div id="contact" class="bg-white rounded-2xl border border-stone-200 p-6">
                <h2 class="text-lg font-bold text-stone-800 mb-3 flex items-center gap-2">
                    <span class="w-7 h-7 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 text-xs font-bold">8</span>
                    Contact Us
                </h2>
                ...
                <div class="space-y-2 text-sm text-stone-600">
                    <p class="flex items-center gap-2"><svg class="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg> privacy@estateflow.com</p>
                    <p class="flex items-center gap-2"><svg class="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/></svg> Unit 5, Realty Building, Quezon City, Metro Manila</p>
                </div>
                <a href="{{ route('client.contact') }}" class="mt-4 inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition">
                    Contact Us
                </a>
            </div>
