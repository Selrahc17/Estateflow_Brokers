...
<div class="bg-gradient-to-r from-[#112E3B] to-[#1A6B79] text-white">
    <div class="max-w-6xl mx-auto px-6 py-10 flex items-center justify-between">
        <div>
            <p class="text-teal-500 text-xs uppercase tracking-widest font-semibold mb-1">Notifications</p>
...
<div class="max-w-6xl mx-auto px-6 py-8">
    ...
    <div class="space-y-3">
        ...
        <div class="bg-white rounded-2xl border border-stone-200 p-5 flex items-start gap-4 hover:shadow-sm transition
            ...
            <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-teal-100">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-start justify-between gap-2 mb-1">
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        @if(!$notif->is_read)
                        <span class="bg-teal-100 text-teal-800 text-xs font-semibold px-2 py-0.5 rounded-full">New</span>
                        @endif
