            ...
            <tr class="hover:bg-stone-50 transition">
                <td class="px-5 py-3">
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('agent.documents.download', $doc) }}" class="font-medium text-stone-700 hover:text-teal-700">{{ $doc->name }}</a>
                    </div>
                </td>
                ...
                <td class="px-5 py-3">
                    ...
                    @else
                    <a href="{{ route('agent.documents.download', $doc) }}" class="text-xs text-teal-700 hover:underline">Download</a>
                    @endif
                </td>
            </tr>
            @empty
