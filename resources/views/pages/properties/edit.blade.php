    ...
    <form method="POST" action="{{ route('broker.properties.update', $property) }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3" class="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400">{{ old('description', $property->description) }}</textarea>
            </div>
