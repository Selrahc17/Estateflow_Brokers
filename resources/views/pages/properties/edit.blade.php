            ...
            <div class="border border-teal-200 rounded-xl p-4 bg-teal-50" x-show="selectedType === 'Lot Only'" x-cloak>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="number" step="0.01" name="lot_area" min="0" value="{{ old('lot_area', $property->lot_area) }}" placeholder="—" class="w-full border border-teal-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-teal-800 mb-1">Frontage (m)</label>
                        <input type="number" step="0.01" name="frontage" min="0" value="{{ old('frontage', $property->frontage) }}" placeholder="—" class="w-full border border-teal-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                    </div>
                </div>
            </div>
