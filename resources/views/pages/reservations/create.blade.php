    ...
    <div class="bg-white rounded-xl border border-stone-200 p-6">
        <form action="{{ route('agent.reservations.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select name="client_id" required class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
            ...
            <div>
                ...
                <select name="lot_id" required class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="total_price" value="{{ old('total_price') }}" step="0.01" min="0" required class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                ...
                <div>
                    ...
                    <input type="number" name="down_payment" value="{{ old('down_payment') }}" step="0.01" min="0" class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                </div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-stone-700 mb-1">Payment Schedule</label>
                    <select name="payment_schedule" class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                ...
                <div>
                    ...
                    <input type="number" name="payment_terms_months" value="{{ old('payment_terms_months', 60) }}" min="1" max="360" required class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
            ...
            <div>
                ...
                <textarea name="notes" rows="3" class="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">{{ old('notes') }}</textarea>
            </div>
            <div class="flex gap-3 pt-2">
                <button type="submit" class="bg-teal-700 hover:bg-teal-800 text-white px-5 py-2 rounded-lg text-sm font-medium transition">Create Reservation</button>
